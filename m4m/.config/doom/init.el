...
(doom! :input
       ...
       (org +roam2 +superstar +noter +jupyter +dragndrop +brain +journal +gnuplot +hugo +pretty)               ; organize your plain life in plain text
       ;;php               ; perl's insecure younger brother
       plantuml          ; diagrams for confusing people more
       graphviz          ; diagrams for confusing yourself even more
       ;;purescript        ; javascript, but functional
       (python +lsp +tree-sitter +poetry +pipenv +pyright +cython)            ; beautiful is better than ugly
       ...
       ;;sml
       ;;solidity          ; do you need a blockkkjjkchain? No.
