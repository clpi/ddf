...
n(">", function()
	d.jump({ count = 1, float = true , enabled = true })
end, "Next diagnostic")
n("<", function()
	d.jump({ count = -1, float = true, enabled = true  })
end, "Prev diagnostic")
...
ln("<space>", function() sp.smart()end, "Smart find")
ln("\\", "AerialToggle", "Aerial")
ln("/", function() sp.grep()end, "live grep")
...
--#region [f]ind
ln("fi", function() sp.smart({cwd="~/infrastructure"})end, "find infrastructure")
ln("fI", function() sp.grep({cwd="~/infrastructure"})end, "find infrastructure")
ln("ff", function() sp.files()end, "Files")
ln("fc", function() sp.files({cwd=vim.fn.stdpath("config")})end, "Config")
ln("fn", function() sp.notifications()end, "Notifications")
ln("fR", function() sp.registers()end, "Notifications")
ln("fF", "lua Snacks.picker.smart({cwd=vim.fn.expand('%:p:h')})", "Files in cwd")
ln("f/", "lua Snacks.picker.grep()", "Grep")
ln("fb", "lua Snacks.picker.buffers()", "Buffers")
ln("fr", "lua Snacks.picker.recent()", "Recent")
ln("fh", "lua Snacks.picker.help()", "Help")
ln("f?", "lua Snacks.picker.grep({cwd=vim.fn.expand('%:p:h')})", "Live grep in cwd")
ln("fG", "lua Snacks.picker.grep({cwd=vim.fn.expand('%:p:h')})", "Live grep in cwd")
ln("f.", "lua Snacks.picker.files({cwd=vim.fn.expand('%:p:h')})", "Files in cwd")
ln("fk", function() sp.keymaps()end, "Keymaps")
lln("fc", function() sp.smart({cwd = vim.fn.expand("~/.config")})end, "Config")
ln("fu", function() sp.undo()end, "Undo")
ln("fz", function() sp.zoxide()end, "Zoxide")
ln("fy", function() sp.cliphist()end, "Cliphist")
ln("f;", "lua Snacks.picker.command_history()", "Command history")
ln("f:", "lua Snacks.picker.commands()", "Commands")
ln("fU", "lua Snacks.picker.colorschemes()", "Colorschemes")
ln("fh", "lua Snacks.picker.help()", "Help Tags")
ln("fm", "lua Snacks.picker.marks()", "Marks")
ln("ft", "lua Snacks.picker.treesitter()", "Treesitter")
ln("fl", "lua Snacks.picker.lines()", "Lines")
...
ln("fp", "lua Snacks.picker.projects()", "Projects")
...
ln("fD", "lua Snacks.picker.trouble()", "Trouble")
ln("fB", function()sp.diagnostics_buffer()end, "Trouble")
...
o("oZ", "~/.zshrc", "zshrc")
o("ozo", "~/.config/zsh/opts", "opts.sh")
ln("of", function() sp.smart({cwd="~/.config"})end, "find dotfiles")
ln("o/", function() sp.grep({cwd="~/.config"})end, "grep dotfiles")
ln("oI", function() sp.smart({cwd="~/infrastructure"})end, "find infrastructure")
ln("oH", function() sp.smart({cwd="~/hg"})end, "find hashgraph")
...
o("op", "~/.config/powershell/profile.ps1", "Powershell")
...
o("ozP", "~/.config/zsh/plugin.sh", "plugin")
...
o("ozm", "~/.config/zsh/maps.sh", "maps")
o("oZ", "~/.config/zsh/zshenv", "zshenv")
ln("o/", "Telescope find_files cwd=~/.config/zsh", "find")
--#endregion
...
o("vL", "~/.config/ne/lua/lsp/lua.lua", "lua.lua")
...
o("vpa", "~/.config/ne/lua/plugins/avante.lua", "Open avante.lua")
...
o("vpC", "~/.config/ne/lua/plugins/colorful-menu.lua", "Open colorful-menu.lua")
...
lln("vu", function()require("vectorcode").update()end, "VectorCode update")

m("n", "<space>e", "<cmd>lua Snacks.explorer()<CR>", { desc="Explorer", silent = true, noremap = true, nowait = true })
...
km({ "n" }, "<C-a>", "<CMD>CodeCompanionActions<CR>", { desc = "CodeCompanion Actions", silent = true, noremap = true, nowait = true })
km({ "n" }, ",C", "<CMD>CodeCompanionChat Toggle<CR>", { desc = "CodeCompanion Chat", silent = true, noremap = true, nowait = true })
km({ "n" }, "ga", "<CMD>CodeCompanionChat Add<CR>", { desc = "CodeCompanion Add", silent = true, noremap = true, nowait = true })
...
ln("gg", "Telescope live_grep cwd=%:p:  ")
