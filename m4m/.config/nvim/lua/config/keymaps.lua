...
-- Utility
-- ln("<s-tab>", vim.call(vim.fn.fnamemodify(vim.fn.finddir(".git", vim.fn.expand("%:p:h") .. ";"), ":h")), "cd Git root")
...
-- [o]pen
ln("oC", "e ~/.cloudflared/config.yml", "Cloudflared config.yml")
ln("oZ", "e ~/.zshrc", "zshrc")
...
ln("op", "e ~/.config/powershell/profile.ps1", "pwsh")
ln("ok", "e ~/.config/kitty/kitty.conf", "kitty.conf")
...
ln("ozs", "e ~/.config/zsh/ssh.sh", "ssh")
...
ln("gg", "Telescope live_grep cwd=%:p:h", "Live grep in cwd")
