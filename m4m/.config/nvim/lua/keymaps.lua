...
n("<space>fo", "<CMD>Telescope oldfiles<CR>", { silent = true, desc = "Oldfiles" })
n("<space>fp", "<CMD>Telescope pickers<CR>", { silent = true, desc = "Pickers" })
n("<space>fd", "<CMD>Telescope diagnostics<CR>", { silent = true, desc = "Pickers" })
n("<space>cd", "<CMD>Trouble diagnostics<CR>", { silent = true, desc = "Trouble diagnostics" })
n("<space>cl", "<CMD>Trouble lsp<CR>", { silent = true, desc = "Trouble lsp" })
n("<space>co", "<CMD>AerialToggle<CR>", { silent = true, desc = "Aerial" })
...
n("<space>vc", "<CMD>e ~/.config/nvim/init.lua<CR>", { silent = true, desc = "init.lua" })
n("<space>vs", "<CMD>e ~/.config/nvim/lua/setup.lua<CR>", { silent = true, desc = "lua/setup.lua" })
n("<space>vk", "<CMD>e ~/.config/nvim/lua/keymaps.lua<CR>", { silent = true, desc = "keymaps.lua" })
n("<space>vp", "<CMD>e ~/.config/nvim/lua/plugins/init.lua<CR>", { silent = true, desc = "plugins.lua" })
n("<space>vd", "<CMD>e ~/.config/nvim/lua/plugins/dap.lua<CR>", { silent = true, desc = "plugins.lua" })
n("<space>vo", "<CMD>e ~/.config/nvim/lua/opts.lua<CR>", { silent = true, desc = "opts.lua" })
n("<space>va", "<CMD>e ~/.config/nvim/lua/abbrev.lua<CR>", { silent = true, desc = "abbrev.lua" })
n("<space>vl", "<CMD>e ~/.config/nvim/lua/lsp.lua<CR>", { silent = true, desc = "lsp.lua" })
n("<space>vv", "<CMD>Telescope find_files cwd=~/.config/nvim<CR>", { silent = true, desc = "find" })
...
vim.cmd([[
  nm 0 ^
  nm <space>vi <CMD>e ~/.config/nvim/init.lua<CR>
]])
vim.keymap.set("n", "<C-k>", "<cmd>cnext<CR>zz")
vim.keymap.set("n", "<C-j>", "<cmd>cprev<CR>zz")
vim.keymap.set("n", "<leader>k", "<cmd>lnext<CR>zz")
vim.keymap.set("n", "<leader>j", "<cmd>lprev<CR>zz")
n("<c-j>", "<c-w>j", { silent = true, nowait = true, noremap = false })
n("<c-h>", "<c-w>h", { silent = true, nowait = true, noremap = false })
n("<c-k>", "<c-w>k", { silent = true, nowait = true, noremap = false })
n("<c-l>", "<c-w>l", { silent = true, nowait = true, noremap = false })
key("t", "<c-p>", "<up>", { silent = true, nowait = true, noremap = true })
key("t", "<c-n>", "<down>", { silent = true, nowait = true, noremap = true })
key({ "c", "i" }, "<c-a>", "<home>")
key({ "c", "i" }, "<c-e>", "<end>")
key({ "c", "i" }, "<c-f>", "<right>")
key({ "c", "i" }, "<c-b>", "<left>")
key({ "n", "i", "t", "v" }, "<c-j>", "<c-w>j")
key({ "n", "i", "t", "v" }, "<c-h>", "<c-w>h")
key({ "n", "i", "t", "v" }, "<c-k>", "<c-w>k")
key({ "n", "i", "t", "v" }, "<c-l>", "<c-w>l")
key("t", "<c-p>", "<up>", { silent = true, nowait = true, noremap = true })
key("t", "<c-n>", "<down>", { silent = true, nowait = true, noremap = true })
