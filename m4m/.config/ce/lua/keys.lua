...
n("<space>vk", "<CMD>e ~/.config/ce/lua/keys.lua<CR>", { silent = true, desc = "keymaps.lua" })
n("<space>vp", "<CMD>e ~/.config/ce/lua/plugin.lua<CR>", { silent = true, desc = "plugins.lua" })
n("<space>vo", "<CMD>e ~/.config/ce/lua/opts.lua<CR>", { silent = true, desc = "opts.lua" })
n("<space>va", "<CMD>e ~/.config/ce/lua/abbrev.lua<CR>", { silent = true, desc = "abbrev.lua" })
