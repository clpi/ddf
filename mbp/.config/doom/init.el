...
(doom! :input
       ...
       (csharp +lsp +unity +tree-sitter +dotnet)            ; unity, .NET, and mono shenanigans
       ...
       ;;gdscr          ; the language you waited for
       ...
       (lua +lsp +fennel +tree-sitter +moonscript)               ; one-based indices? one-based indices
       ...
       (python +lsp +cython +poetry +tree-sitter +conda +pyenv +pyright)            ; beautiful is better than ugly
